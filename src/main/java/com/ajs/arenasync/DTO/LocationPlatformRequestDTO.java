...
public class LocationPlatformRequestDTO {
    ...
    @Schema(description = "Tipo do local/plataforma (ESPORT ou SPORT)", example = "ESPORT", allowableValues = { "SPORT",
            "ESPORT" }) // Adicionado allowableValues para enums no Swagger
